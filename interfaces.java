...
public class interfaces {
    ...
    public void interFaceAdmin(Login login) {
        ...
        Image image = new Image("file:E:/Develop-a-Java-application-for-library-management/src/main/image/hoa.jpg"); // Đường dẫn đến hình ảnh
...
HBox accountHBox =  accountHBox("Thông Tin Tài Khoản", login);
   ...
   HBox accountHBox(String s, Login login) {
    ...
    public static String userId() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("E:\\Develop-a-Java-application-for-library-management\\src\\main\\text\\user_id.txt"))) {
